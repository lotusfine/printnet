...
// Decide qué layout renderizar según la ruta
const AppRoutes = ({ infoGeneral, novedades }) => {
  const { pathname } = useLocation();
  if (pathname.startsWith('/admin')) return <Admin />;
  return <SiteShell infoGeneral={infoGeneral} novedades={novedades} />;
};
...
function App() {
  ...
  return (
    <Router>
      <AppRoutes infoGeneral={infoGeneral} novedades={novedades} />
    </Router>
  );
}
